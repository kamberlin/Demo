...
public class NursesService {
	...
	public void update(String employeeNo, String nurseName, String oriEmployeeNo, String oriNurseName) {
		nursesDao.updateNurse(employeeNo, nurseName, oriEmployeeNo, oriNurseName);
	}
}
